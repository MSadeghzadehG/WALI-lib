...
### Tier 1: Critical Infrastructure (Must Have) - FaaS Core
...
| **cJSON** | Data/JSON | ❌ Not started | P0 | JSON is used in every FaaS function |
| **jansson** | Data/JSON | ❌ Not started | P0 | Alternative to cJSON with cleaner API |
| **OpenSSL** / **libcrypto** | Cryptography | ❌ Not started | P0 | Security-critical, don't reimplement |
| **hiredis** | Database/Cache | ❌ Not started | P0 | Redis essential for caching and sessions |
...
| **brotli** | Compression | ❌ Not started | P1 | HTTP compression standard |
| **libpq** | Database | ❌ Not started | P1 | PostgreSQL client - most popular cloud DB |
| **lz4** | Compression | ❌ Not started | P2 | Very fast compression |
...
| Library | Category | Status | Priority | Notes |
|---------|----------|--------|----------|-------|
| **libjwt** | Authentication | ❌ Not started | P1 | API authentication with JWT |
...
| Library | Category | Status | Priority | Notes |
|---------|----------|--------|----------|-------|
| **libsodium** | Crypto | ❌ Not started | P2 | Modern crypto API, simple |
| **mongo-c-driver** | Database | ❌ Not started | P2 | MongoDB client |
| **librdkafka** | Message Queue | ❌ Not started | P3 | Kafka client (complex - threads) |
| **rabbitmq-c** | Message Queue | ❌ Not started | P3 | RabbitMQ/AMQP client |
...
Based on research on common patterns in FaaS/Serverless workloads:

### Most Used Libraries in FaaS

| Category | Library | FaaS Usage | Wrapper Complexity |
|----------|---------|------------|-------------------|
| **JSON** | cJSON, jansson | Very High | **Very Low** |
| **HTTP** | libcurl | Very High | High (callbacks) |
| **Cache** | hiredis | Very High | **Low** (sync mode) |
| **Relational DB** | libpq | Very High | Medium |
| **Cryptography** | OpenSSL, libsodium | Ubiquitous | High / **Low** |
| **Compression** | zstd, brotli, lz4 | High | **Low** |
| **Message Queue** | librdkafka | Medium | High (threads) |
| **NoSQL** | mongo-c-driver | Medium | Medium |
| **JWT** | libjwt | Medium | Low |

### Wrapper Complexity Guide
...
- [ ] cJSON/jansson - JSON parsing (essential for FaaS)
- [ ] hiredis - Redis client (sync)
...
- [ ] lz4, bzip2, lzma - Additional compression

### Phase 4: Ecosystem
- [ ] libsodium - Simple crypto
- [ ] mongo-c-driver - MongoDB client
- [ ] libuv - Async I/O
- [ ] libffi - FFI support
...
1. **cJSON/jansson wrappers** - Most impactful next step for FaaS
2. **hiredis wrappers** - Redis cache support
3. **OpenSSL wrappers** - Core cryptography
4. **SQLite wrappers** - Widely requested
5. **Tests for existing libraries** - Improve coverage
6. **Documentation** - Usage examples, guides
